...
function applyFilters() {
    ...
    products.forEach(product => {
        ...
        const productGender = product.getAttribute('data-gender').split(',');
        ...
        let genderMatch = selectedGender.length === 0 || selectedGender.some(gender => productGender.includes(gender));
        let categoryMatch = selectedCategory.length === 0 || selectedCategory.some(category => productCategory.includes(category));
