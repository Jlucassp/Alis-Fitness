<?php
/*
Template Name: Shorts Masculinos
*/
?>
...
<body class=product-page>
    ...
    <section id="content">
        <h2 class="camisas-title">Shorts Masculinos</h2>
                            ...
                            $args = array(
                                ...
                                'tax_query' => array(
                                    array(
                                        ...
                                        'field'    => 'slug',
                                        'terms'    => 'shortsm', // Categoria "camisasm"
                                    ),
                                ),
                            );
                    ...
                    $args = array(
                        ...
                        'tax_query' => array(
                            array(
                                ...
                                'terms'    => 'shortsm',     // Alterado para a categoria "camisasm"
                                'operator' => 'IN',
                            ),
                        ),
                    );
