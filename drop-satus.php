...
<body class=product-page>
    ...
    <section id="content">
        <h2 class="camisas-title">Drop Satus</h2>
        ...
        <div class="main-content">
            ...
            <aside id="filter-sidebar-satus" class="camisas-filter">
                ...
                <div id="filter-options-container">
                    ...
                    <div class="filter-group">
                        ...
                        <div class="filter-options">
                            ...
                            foreach ($terms as $term) {
                                echo '<label><input type="checkbox" name="gender" value="' . $term->slug . '" data-name="' . $term->name . '"> ' . $term->name . '</label><br>';
                            }
                            ?>
                        </div>
                    </div>
                    ...
                    <div class="filter-group">
                        ...
                        <div class="filter-options">
                            <?php
                            // Exibe as categorias de produto
                            $categories = get_terms(array(
                                'taxonomy' => 'product_cat',
                                'orderby' => 'name',
                                'hide_empty' => 'false',
                                'exclude' => array(
                                    get_term_by('slug', 'satus', 'product_cat')->term_id,
                                    get_term_by('slug', 'tops-sheer', 'product_cat')->term_id,
                                    get_term_by('slug', 'tops-prize', 'product_cat')->term_id
                                ),
                            ));
                            foreach ($categories as $category) {
                                echo '<label><input type="checkbox" name="category" value="' . $category->slug . '" data-name="' . $category->name . '"> ' . $category->name . '</label><br>';
                            }
                            ?>
                        </div>
                    </div>
                    ...
                    <div class="filter-group">
                        ...
                        <div class="filter-options">
                            ...
                            $colors = get_terms(array(
                                ...
                                'hide_empty' => false,
                                'exclude' => array(
                                    get_term_by('slug', 'vinho', 'pa_cor')->term_id
                                ),
                            ));
            ...
            <section id="collection-section">
                <div class="collection-grid">
                    ...
                    // Verificar e aplicar o filtro de gênero
                    ...
                    // Verificar e aplicar o filtro de categoria
                    ...
                    if ($loop->have_posts()) :
                        while ($loop->have_posts()) : $loop->the_post(); global $product; ?>
                            ...
                            <div class="product" id="product-<?php echo get_the_ID(); ?>" data-images='<?php echo esc_attr(json_encode($images)); ?>' data-prices='<?php echo esc_attr(json_encode($prices)); ?>'
                                data-gender="<?php echo join(',', wp_get_post_terms(get_the_ID(), 'pa_genero', array('fields' => 'slugs'))); ?>"
                                data-category="<?php echo join(',', wp_get_post_terms(get_the_ID(), 'product_cat', array('fields' => 'slugs'))); ?>"
    ...
    <script src="<?php echo get_template_directory_uri(); ?>/js/produtos.js?ver=<?php echo filemtime(get_template_directory() . '/js/produtos.js'); ?>"></script>
