<?php
/*
Template Name: Shorts Femininos
*/
?>
...
<body class=product-page>
    ...
    <section id="content">
        <h2 class="camisas-title">Shorts Femininos</h2>
                            ...
                            $args = array(
                                ...
                                'tax_query' => array(
                                    array(
                                        ...
                                        'field'    => 'slug',
                                        'terms'    => 'shortsf', // Categoria "camisasm"
                                    ),
                                ),
                            );
                    ...
                    $args = array(
                        ...
                        'tax_query' => array(
                            array(
                                ...
                                'terms'    => 'shortsf',     // Alterado para a categoria "camisasm"
                                'operator' => 'IN',
                            ),
                        ),
                    );
